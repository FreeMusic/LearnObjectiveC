...
#import "LXYImageBrowserModel.h"
#import "LXYImageBrowserSubView.h"

@interface LXYImageBrowserMainView ()<UIScrollViewDelegate, LXYImageBrowserSubViewDelegate>
...
@implementation LXYImageBrowserMainView
...
+ (id)imageBrowserMainViewUrlStr:(NSArray<NSString *>*)imageUrls originImageViews:(NSArray<UIImageView *>*)originImageViews selectPage:(NSInteger)selectPage {
    LXYImageBrowserMainView * imageBrowserMainView = [[LXYImageBrowserMainView alloc] initWithFrame:Screen_Frame];
...
- (void)initData {
    for (NSInteger i = 0; i < self.imageUrls.count; i++) {
        ...
        LXYImageBrowserModel * imageBrowserModel = [[LXYImageBrowserModel alloc] init];
...
- (void)initView {
    ...
    for (NSInteger i = 0; i < self.dataSource.count; i++) {
        LXYImageBrowserSubView * imageBrowserSubView = [[LXYImageBrowserSubView alloc] initWithFrame:CGRectMake((Screen_Width + SpaceWidth)*i, 0, Screen_Width, Screen_Height) ImageBrowserModel:self.dataSource[i]];
...
- (void)imageBrowserSubViewSingleTapWithModel:(LXYImageBrowserModel *)imageBrowserModel {
