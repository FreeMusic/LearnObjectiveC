...
@interface LXYImageBrowserTranslation ()

@end

@implementation LXYImageBrowserTranslation
/* 自定义转场动画 */
//动画时间
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    LXYImageBrowserModel * currentModel = [dataM objectAtIndex:currentIndex];
