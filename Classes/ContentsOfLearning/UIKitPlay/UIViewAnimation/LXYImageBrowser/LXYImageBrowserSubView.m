...
@interface LXYImageBrowserSubView ()<UIScrollViewDelegate>

@property (nonatomic, strong) LXYImageBrowserModel *imageBrowserModel;//
...
@implementation LXYImageBrowserSubView
